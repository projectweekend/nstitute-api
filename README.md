...
### List N-Sider archive articles for year

**GET:**
```
/nsider-archive/year/:publishedYear
```
...
* `200` if successful
* `400` if invalid query parameters
* `404` if articles do not exist for year



### List N-Sider archive articles for year and month

**GET:**
```
/nsider-archive/year/:publishedYear/month/:publishedMonth
```
...
* `200` if successful
* `400` if invalid query parameters
* `404` if articles do not exist for year and month
